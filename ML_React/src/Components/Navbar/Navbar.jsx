...
const Navbar = () => {
    ...
    <header class="bg-zinc-700">
        <nav class="flex justify-between items-center w-[92%]  mx-auto text-2xl py-7">
            <div>
                <img class="w-10 cursor-pointer" src="https://cdn4.iconfinder.com/data/icons/weather-conditions/512/lightning-512.png" alt="..." />
            </div>
            ...
            md:min-h-fit min-h-[60vh] left-0 top-[-100%] md:w-auto  w-full flex items-center px-5">
                <ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8 text-amber-50">
                    <li>
